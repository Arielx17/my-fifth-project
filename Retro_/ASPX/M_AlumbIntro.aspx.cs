            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["GId"] != null)
                {
                    ...
                    while (sdr.Read())
                    {
                        ...
                        string price = sdr["GPrice"].ToString();
                        float a;
                        if (!float.TryParse(price, out a))
                        {
                            a = 0F;
                            Goods.GPrice = a;
                        }
                        string stock = sdr["GStock"].ToString();
                        int b;
                        if (stock == null)
                        {
                            b = 0;
                        ...
                        string post = sdr["GPost"].ToString();
                        if (!float.TryParse(post, out a))
                        {
                            a = 0F;
                            Goods.GPost = a;
                        }
